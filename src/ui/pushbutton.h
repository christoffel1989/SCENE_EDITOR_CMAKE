...
private:
    ...
    const float _childWidgetShrinkRatio = 0.9f;
    ...
    const float _activatedLengthRatio = 0.4f;
    const float _hoveredLengthRatio = 0.5f;
    const float _pressedLengthRatio = 0.2f;
