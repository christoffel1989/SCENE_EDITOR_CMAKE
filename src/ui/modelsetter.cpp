    ...
    QWidget(parent), _object(object)
{
    ...
    // Create Object Settings Panel
    {
        ...
        _scale = new ModelAttributeSlide("Scale", 0.1f, 10.0f, 100, _objectSettingPanel);
        _rotateX = new ModelAttributeSlide("RotateX", 0.0f, 360.0f, 3600, _objectSettingPanel);
        _rotateY = new ModelAttributeSlide("RotateY", 0.0f, 360.0f, 3600, _objectSettingPanel);
        _rotateZ = new ModelAttributeSlide("RotateZ", 0.0f, 360.0f, 3600, _objectSettingPanel);
    ...
    // Create light switches
    {
        ...
        _lightColorPanelIcon->setText(u8"\uf53f");
    ...
    // Create light setting panel
    {
        ...
        _lightRotateTheta = new ModelAttributeSlide(u8"Rotate\u03B8", 0, 360, 3600, _lightSettingPanel);
        _lightRotatePhi = new ModelAttributeSlide(u8"Rotate\u03C6", 0, 360, 3600, _lightSettingPanel);
