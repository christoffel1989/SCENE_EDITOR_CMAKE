    ...
    PageWidget(parent)
{
    ...
    _dirLightTheta = new ModelAttributeSlide(u8"Rotate\u03B8", 0, 360, 3600, _mainWidget);
    ...
    _dirLightPhi = new ModelAttributeSlide(u8"Rotate\u03C6", 0, 360, 3600, _mainWidget);
